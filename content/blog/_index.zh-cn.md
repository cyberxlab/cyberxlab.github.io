...
<section class="not-prose hx:relative hx:overflow-hidden hx:rounded-2xl hx:mb-12 hx:w-full" style="height: 280px; display: block;">
  <img src="/images/articles-hero.webp" alt="Cyber·X·Lab 博客" style="position:absolute; inset:0; width:100%; height:100%; object-fit:cover; object-position:center; display:block;" loading="lazy" decoding="async" />
...
{{< cards >}}
  {{< card
        link="/zh-cn/blog/cyberxlab-launch/"
        title="Cyber·X·Lab 正式上线公告"
        subtitle="Cyber·X·Lab 正式上线啦！了解平台、我们的使命以及接下来的规划。"
  >}}
{{< /cards >}}
